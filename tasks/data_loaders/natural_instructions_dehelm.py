...
class StreamDataset(IterableDataset):
    def __init__(self, data_path, tokenizer, seq_length=1024):
        ...
        if not os.path.isdir(data_path):
            os.system(f'git clone https://github.com/LorrinWWW/natural-instructions.git {data_path}')
        
        self.train_splits = []
        with open(os.path.join(data_path, 'splits/default/train_tasks_dehelm.txt')) as f:
            for line in f:
                if line.strip() == '':
                    continue
