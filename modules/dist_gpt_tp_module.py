...
class GPTStageBase(nn.Module):
    def __init__(self, args, config):
        ...
        self._layer_begin = 0
        self._layer_end = args.num_layers
        ...
        if hasattr(args, 'model_type'):
            if args.model_type == "flash_gptneox_parallel": 
                from .hf_flash_gptneox_parallel_modules import GPTEmbeddings, GPTBlock, GPTLMHead
            else:
