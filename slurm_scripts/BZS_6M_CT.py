...
export WANDB_NAME=RP-7B-700BT-fix-wiki-cocktail
...
ARGS="--model-name /var/cr01_data/_root_fm_models_rp_700b_real_fp16 \
--tokenizer-name /var/cr01_data/_root_fm_models_rp_700b_real_fp16 \
