...
ARGS="--model-name /var/cr01_data/_root_fm_models_rp_3b_800b_real_fp16 \
--tokenizer-name /var/cr01_data/_root_fm_models_rp_3b_800b_real_fp16 \
...
--num-layers {{N_LAYER_PER_DEVICE}} --embedding-dim 2560 \
--initial-loss-scale 4096 \
--total-steps 159000 --warmup-steps 10 --train-warmup-steps 0 \
--stop-steps 2001 \
--checkpoint-steps 20000 \
--lr 1e-5 --seq-length 2048 --batch-size 32 --micro-batch-size 2 --gradient-accumulate-step 4 \
